...
function enhanceSettings(){
  ...
  interfaceSection.innerHTML=`<span class="settings-label">Interface</span><div class="pm-interface-segment" role="group" aria-label="Interface mode"><button type="button" data-interface-mode="auto" aria-label="Automatic interface"><span class="pm-interface-auto">A</span><small>Auto</small></button><button type="button" data-interface-mode="mobile" aria-label="Mobile interface"><span class="pm-interface-device-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="7" y="2.5" width="10" height="19" rx="2.2" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M10.5 5h3M11 18.5h2" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg></span><small>Mobile</small></button><button type="button" data-interface-mode="desktop" aria-label="Desktop interface"><span class="pm-interface-device-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M8 20h8M12 16v4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg></span><small>Desktop</small></button></div><p class="pm-settings-note">Auto adapts to your screen. Your choice is remembered on this device.</p>`;
